        ...
        <>
            ...
            <div className={styles.about}>
                ...
                <section className={styles.videoSection}>
                    <img src="/assets/ab2.jpg" alt="About video" className={styles.videoBg} />
                ...
                <section className={styles.skills}>
                    <div className={styles.text}>
                        ...
                        <p>
                            ...
                            mattis volutpat id. Egestas adipiscing placerat eleifend a nascetur.
                        ...
                        {[
                            ...
                            <div key={idx} className={styles.bar}>
                                ...
                                <div className={styles.barTrack}>
                                    <div className={styles.barFill} style={{ width: `${bar.value}%` }}></div>
                                </div>
                            </div>
                        ))}
                    </div>
