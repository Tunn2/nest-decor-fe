      ...
      <div className={styles.home}>
        ...
        <section className={styles.bannerSection}>
          <div className={styles.bannerContent}>
            <p>
              Illuminate your space with contemporary lights that blend style
        ...
        <section className={styles.contemporaryLamps}>
          <div className={styles.lampContent}>
            ...
            <p>
              Brighten your home with sleek, minimalist lamps that reflect
              modern elegance and everyday functionality.
            </p>
            <button>View more →</button>
          </div>
