            ...
            <div className={styles.home}>
                ...
                <section className={styles.hero}>
                    <div className={styles.heroContent}>
                        ...
                        <p>
                            Turn your living space into a true home with sophisticated, luxurious and inspiring furniture and decoration products.
                        </p>
                ...
                <section className={styles.bannerSection}>
                    <div className={styles.bannerContent}>
                        <p>Illuminate your space with contemporary lights that blend style and comfort seamlessly.</p>
                        <button>View more →</button>
                    </div>
                </section>
                ...
                <section className={styles.stylishChairs}>
                    <div className={styles.chairContent}>
                        ...
                        <p>Elevate your interior with sleek, modern chairs that combine style and comfort in perfect harmony.</p>
                        <button>View more →</button>
                    </div>
                    <div className={styles.chairImage}>
                        <img src="https://furniture123.co.uk/Images/BUNKOR00195433_3_Supersize.jpg?v=79" alt="Stylish Chair" />
                    </div>
                </section>
                ...
                <section className={styles.tableSection}>
                    <div className={styles.tableImage}>
                        <img src="https://mysleepyhead.com/media/catalog/product/s/l/sleepyhead_product_ls_309_new.jpg" alt="Table" />
                    </div>
                    <div className={styles.tableContent}>
                        <h2>TABLE</h2>
                        <p>Functional and elegant tables designed to fit perfectly into your modern lifestyle and home space.</p>
                        <button>View more →</button>
                    </div>
                </section>
                ...
                <section className={styles.contemporaryLamps}>
                    <div className={styles.lampContent}>
                        ...
                        <p>Brighten your home with sleek, minimalist lamps that reflect modern elegance and everyday functionality.</p>
                        <button>View more →</button>
                    </div>
                    <div className={styles.lampImage}>
                        <img src="https://www.livingandhome.co.uk/cdn/shop/products/1_21c04911-4665-449a-b182-86162a75fa31.jpg?v=1694060842" alt="Contemporary Lamp" />
                    </div>
                </section>
